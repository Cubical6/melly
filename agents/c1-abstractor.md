...
1. Create output following template structure (see `validation/templates/c1-systems-template.json`)
...
3. Or create system folders: bash validation/scripts/create-folders.sh c1-systems.json
```
