...
python plugins/melly-validation/scripts/validate-c1-systems.py knowledge-base/c1-systems.json

# Validate observations and relations in c2-containers.json
python plugins/melly-validation/scripts/validate-c2-containers.py knowledge-base/c2-containers.json

# Validate observations and relations in c3-components.json
python plugins/melly-validation/scripts/validate-c3-components.py knowledge-base/c3-components.json
```
