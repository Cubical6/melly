...
- Validate: `cat c2-containers.json | python plugins/melly-validation/scripts/validate-c2-containers.py`
...
- **Schema**: See `plugins/melly-validation/templates/c2-containers-template.json`
- **Validation**: See `plugins/melly-validation/scripts/validate-c2-containers.py`
