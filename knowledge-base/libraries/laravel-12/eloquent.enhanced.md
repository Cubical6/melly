...
file_info:
  name: eloquent.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/eloquent.md
  size: 67355
structure:
  headings_count: 68
  code_blocks_count: 115
  internal_links_count: 73
processed_at: '2025-11-21T15:35:16.362946Z'
---
...
2. The primary key associated with the table.
3. Indicates if the model's ID is auto-incrementing.
4. The data type of the primary key ID.
5. Generate a new UUID for the model.
6. Get the columns that should receive a unique identifier.
7. @return array<int, string>
8. Indicates if the model should be timestamped.
9. The storage format of the model's date columns.
