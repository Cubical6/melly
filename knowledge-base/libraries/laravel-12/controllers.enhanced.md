...
file_info:
  name: controllers.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/controllers.md
  size: 27127
structure:
  headings_count: 32
  code_blocks_count: 47
  internal_links_count: 27
processed_at: '2025-11-21T15:35:13.575315Z'
---
...
1. Show the profile for a given user.
2. Provision a new web server.
3. Get the middleware that should be assigned to the controller.
