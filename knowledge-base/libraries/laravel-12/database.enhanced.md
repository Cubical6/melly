...
file_info:
  name: database.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/database.md
  size: 21464
structure:
  headings_count: 29
  code_blocks_count: 35
  internal_links_count: 22
processed_at: '2025-11-21T15:35:14.270855Z'
---
...
1. MariaDB 10.3+ ([Version Policy](https://mariadb.org/about/#maintenance-policy))
2. MySQL 5.7+ ([Version Policy](https://en.wikipedia.org/wiki/MySQL#Release_history))
3. PostgreSQL 10.0+ ([Version Policy](https://www.postgresql.org/support/versioning/))
4. SQL Server 2017+ ([Version Policy](https://docs.microsoft.com/en-us/lifecycle/products/?products=sql-server))
5. Show a list of all of the application's users.
