...
file_info:
  name: homestead.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/homestead.md
  size: 34330
structure:
  headings_count: 49
  code_blocks_count: 47
  internal_links_count: 43
processed_at: '2025-11-21T15:35:19.146727Z'
---
...
1. Node (With Yarn, Bower, Grunt, and Gulp)
2. XHProf / Tideways / XHGui
3. Crystal & Lucky Framework
4. RVM (Ruby Version Manager)
5. Trader <small>(PHP extension)</small>
6. Webdriver & Laravel Dusk Utilities
7. map: ~/code/project1
8. map: ~/code/project2
9. map: homestead.test
10. chronograf: true
