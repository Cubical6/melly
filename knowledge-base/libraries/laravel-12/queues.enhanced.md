...
file_info:
  name: queues.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/queues.md
  size: 118000
structure:
  headings_count: 107
  code_blocks_count: 167
  internal_links_count: 121
processed_at: '2025-11-21T15:35:25.646191Z'
---
...
2. Beanstalkd: `pda/pheanstalk ~5.0`
3. Redis: `predis/predis ~2.0` or phpredis PHP extension
4. Create a new job instance.
5. Execute the job.
6. The product instance.
7. @var \App\Models\Product
8. The number of seconds after which the job's unique lock will be released.
9. Get the unique ID for the job.
10. Get the cache driver for the unique job lock.
