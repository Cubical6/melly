...
file_info:
  name: blade.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/blade.md
  size: 69671
structure:
  headings_count: 75
  code_blocks_count: 160
  internal_links_count: 66
processed_at: '2025-11-21T15:35:10.784175Z'
---
...
2. Bootstrap your package's services.
3. Whether the component should be rendered
4. Create the component instance.
5. Get the view / contents that represent the component.
6. Determine if the given option is the currently selected option.
