...
file_info:
  name: socialite.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/socialite.md
  size: 9114
structure:
  headings_count: 14
  code_blocks_count: 12
  internal_links_count: 14
processed_at: '2025-11-21T15:35:28.770522Z'
---
...
1. Bot (prefixed with `xoxb-`)
2. User (prefixed with `xoxp-`)

### Related Documentation

- [the upgrade guide](https://github.com/laravel/socialite/blob/master/UPGRADE.md)
