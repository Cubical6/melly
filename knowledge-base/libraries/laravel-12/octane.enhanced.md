...
file_info:
  name: octane.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/octane.md
  size: 29485
structure:
  headings_count: 35
  code_blocks_count: 46
  internal_links_count: 32
processed_at: '2025-11-21T15:35:22.775319Z'
---
...
1. '${APP_PORT:-80}:80'
2. '${VITE_PORT:-5173}:${VITE_PORT:-5173}'
3. '443:443' # [tl! add]
4. '443:443/udp' # [tl! add]
