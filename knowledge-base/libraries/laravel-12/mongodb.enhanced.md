...
file_info:
  name: mongodb.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/mongodb.md
  size: 5882
structure:
  headings_count: 8
  code_blocks_count: 6
  internal_links_count: 7
processed_at: '2025-11-21T15:35:22.315490Z'
---
...
1. The `mongodb` [cache driver](https://www.mongodb.com/docs/drivers/php/laravel-mongodb/current/cache/) is optimized to use MongoDB features such as TTL indexes to automatically clear expired cache entries.
2. Most third party packages using a database connection or Eloquent can be used with MongoDB.
