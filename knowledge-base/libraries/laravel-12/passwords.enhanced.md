...
file_info:
  name: passwords.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/passwords.md
  size: 14889
structure:
  headings_count: 19
  code_blocks_count: 9
  internal_links_count: 20
processed_at: '2025-11-21T15:35:23.657272Z'
---
...
1. `database` - password reset data is stored in a relational database.
2. `cache` - password reset data is stored in one of your cache-based stores.
