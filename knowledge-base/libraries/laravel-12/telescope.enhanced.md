...
file_info:
  name: telescope.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/telescope.md
  size: 17296
structure:
  headings_count: 32
  code_blocks_count: 24
  internal_links_count: 47
processed_at: '2025-11-21T15:35:29.628563Z'
---
...
3. This gate determines who can access Telescope in non-local environments.

### Related Documentation

- [the upgrade guide](https://github.com/laravel/telescope/blob/master/UPGRADE.md)
