...
file_info:
  ...
  path: /home/user/melly/knowledge-base/libraries/laravel-12/authorization.md
  size: 32250
structure:
  headings_count: 34
  code_blocks_count: 44
  internal_links_count: 34
processed_at: '2025-11-21T15:35:10.300026Z'
---
...
3. Determine if the given post can be updated by the user.
4. Determine if the given user can create posts.
5. Perform pre-authorization checks.
6. Update the given blog post.
7. @throws \Illuminate\Auth\Access\AuthorizationException
8. Create a new blog post.
9. Define the props that are shared by default.
