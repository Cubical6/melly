...
file_info:
  ...
  path: /home/user/melly/knowledge-base/libraries/laravel-12/notifications.md
  size: 74400
structure:
  headings_count: 79
  code_blocks_count: 104
  internal_links_count: 79
processed_at: '2025-11-21T15:35:22.550483Z'
---
...
1. Get the notification's delivery channels.
2. @return array<int, string>
3. Determine the notification's delivery delay.
4. @return array<string, \Illuminate\Support\Carbon>
5. Create a new notification instance.
6. Determine which connections should be used for each notification channel.
7. @return array<string, string>
8. Determine which queues should be used for each notification channel.
9. The number of times the notification may be attempted.
10. The number of seconds the notification can run before timing out.
