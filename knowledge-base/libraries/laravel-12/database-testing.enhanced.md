...
- user
file_info:
  name: database-testing.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/database-testing.md
  size: 8319
structure:
  headings_count: 15
  code_blocks_count: 17
  internal_links_count: 9
processed_at: '2025-11-21T15:35:14.046844Z'
---
...
1. A basic functional test example.
2. Test creating a new order.
3. Indicates whether the default seeder should run before each test.
