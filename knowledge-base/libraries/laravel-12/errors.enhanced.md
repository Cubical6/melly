...
file_info:
  name: errors.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/errors.md
  size: 19516
structure:
  headings_count: 19
  code_blocks_count: 27
  internal_links_count: 16
processed_at: '2025-11-21T15:35:17.051672Z'
---
...
1. Get the exception's context information.
2. @return array<string, mixed>
3. Report the exception.
4. Render the exception as an HTTP response.
