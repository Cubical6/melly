...
file_info:
  ...
  path: /home/user/melly/knowledge-base/libraries/laravel-12/authentication.md
  size: 46527
structure:
  headings_count: 43
  code_blocks_count: 42
  internal_links_count: 68
processed_at: '2025-11-21T15:35:10.067581Z'
---
...
1. Update the flight information for an existing flight.
2. Handle an authentication attempt.
3. Handle an incoming request.
4. @param  \Closure(\Illuminate\Http\Request): (\Symfony\Component\HttpFoundation\Response)  $next
