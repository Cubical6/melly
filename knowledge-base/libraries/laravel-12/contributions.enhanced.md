...
file_info:
  ...
  path: /home/user/melly/knowledge-base/libraries/laravel-12/contributions.md
  size: 8664
structure:
  headings_count: 11
  code_blocks_count: 3
  internal_links_count: 10
processed_at: '2025-11-21T15:35:13.347829Z'
---
...
2. @param  string|array  $abstract
3. @param  \Closure|string|null  $concrete
4. @param  bool  $shared
5. @throws \Exception
6. Execute the job.
7. Get the attachments for the message.
8. @return array<int, \Illuminate\Mail\Mailables\Attachment>
