...
- values
file_info:
  name: eloquent-mutators.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/eloquent-mutators.md
  size: 34790
structure:
  headings_count: 29
  code_blocks_count: 46
  internal_links_count: 26
processed_at: '2025-11-21T15:35:15.434280Z'
---
...
3. Interact with the user's first name.
4. `AsFluent::class`
5. `AsStringable::class`
6. `immutable_date`
7. `immutable_datetime`
8. <code>decimal:&lt;precision&gt;</code>
9. `encrypted:array`
10. `encrypted:collection`
