...
file_info:
  name: events.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/events.md
  size: 36368
structure:
  headings_count: 34
  code_blocks_count: 50
  internal_links_count: 35
processed_at: '2025-11-21T15:35:17.279036Z'
---
...
5. The name of the connection the job should be sent to.
6. @var string|null
7. The name of the queue the job should be sent to.
8. The time (seconds) before the job should be processed.
9. Get the name of the listener's queue connection.
