...
- without
file_info:
  name: cashier-paddle.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/cashier-paddle.md
  size: 65304
structure:
  headings_count: 62
  code_blocks_count: 116
  internal_links_count: 77
processed_at: '2025-11-21T15:35:11.483429Z'
---
...
1. Bootstrap any application services.
2. Handle the incoming Cashier webhook event.
3. Handle an incoming request.
4. Get the customer's name to associate with Paddle.
5. Get the customer's email address to associate with Paddle.
6. @param  \Closure(\Illuminate\Http\Request): (\Symfony\Component\HttpFoundation\Response)  $next
7. Register any application services.
8. Customer Updated
9. Transaction Completed
10. Transaction Updated

### Related Documentation

- [the upgrade guide](https://github.com/laravel/cashier-paddle/blob/master/UPGRADE.md)
