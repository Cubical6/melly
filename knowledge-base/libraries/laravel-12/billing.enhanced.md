...
file_info:
  name: billing.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/billing.md
  size: 113171
structure:
  headings_count: 102
  code_blocks_count: 197
  internal_links_count: 103
processed_at: '2025-11-21T15:35:10.533306Z'
---
...
4. Get the customer name that should be synced to Stripe.
5. @param  \Closure(\Illuminate\Http\Request): (\Symfony\Component\HttpFoundation\Response)  $next
6. Register any application services.
7. The tax rates that should apply to the customer's subscriptions.
8. @return array<int, string>
9. @return array<string, array<int, string>>
10. `customer.subscription.created`

### Related Documentation

- [the upgrade guide](https://github.com/laravel/cashier-stripe/blob/master/UPGRADE.md)
