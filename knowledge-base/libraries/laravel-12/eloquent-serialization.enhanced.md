...
- visibility
file_info:
  name: eloquent-serialization.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/eloquent-serialization.md
  size: 8480
structure:
  headings_count: 13
  code_blocks_count: 16
  internal_links_count: 12
processed_at: '2025-11-21T15:35:16.130680Z'
---
...
1. The attributes that should be hidden for serialization.
2. @var array<string>
3. The attributes that should be visible in arrays.
4. Determine if the user is an administrator.
5. The accessors to append to the model's array form.
6. Prepare a date for array / JSON serialization.
