...
file_info:
  name: pennant.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/pennant.md
  size: 40802
structure:
  headings_count: 45
  code_blocks_count: 66
  internal_links_count: 44
processed_at: '2025-11-21T15:35:23.882893Z'
---
...
2. All internal team members should be using the new API.
3. Any high traffic customers should not be using the new API.
4. Otherwise, the feature should be randomly assigned to users with a 1 in 100 chance of being active.
5. Resolve the feature's initial value.
