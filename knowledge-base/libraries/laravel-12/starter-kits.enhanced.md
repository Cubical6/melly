...
- your
file_info:
  name: starter-kits.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/starter-kits.md
  size: 18336
structure:
  headings_count: 33
  code_blocks_count: 26
  internal_links_count: 20
processed_at: '2025-11-21T15:35:28.991326Z'
---
...
1. Social authentication (Google, Microsoft, GitHub, and Apple)
2. Passkey authentication
3. Email based "Magic Auth"
