...
file_info:
  name: upgrade.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/upgrade.md
  size: 9365
structure:
  headings_count: 27
  code_blocks_count: 11
  internal_links_count: 11
processed_at: '2025-11-21T15:35:30.023300Z'
---
...
1. `laravel/framework` to `^12.0`
2. `phpunit/phpunit` to `^11.0`
3. `pestphp/pest` to `^3.0`
