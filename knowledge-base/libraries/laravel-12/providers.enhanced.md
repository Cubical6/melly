...
file_info:
  name: providers.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/providers.md
  size: 8483
structure:
  headings_count: 9
  code_blocks_count: 8
  internal_links_count: 13
processed_at: '2025-11-21T15:35:25.029925Z'
---
...
2. All of the container bindings that should be registered.
3. All of the container singletons that should be registered.
4. Bootstrap any application services.
5. Get the services provided by the provider.
