...
file_info:
  name: packages.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/packages.md
  size: 17868
structure:
  headings_count: 24
  code_blocks_count: 28
  internal_links_count: 26
processed_at: '2025-11-21T15:35:23.001503Z'
---
...
1. Bootstrap any package services.
2. Register any package services.
3. Bootstrap the package services.
