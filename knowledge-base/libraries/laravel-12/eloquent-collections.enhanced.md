...
- user
file_info:
  name: eloquent-collections.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/eloquent-collections.md
  size: 12140
structure:
  headings_count: 26
  code_blocks_count: 25
  internal_links_count: 34
processed_at: '2025-11-21T15:35:14.954577Z'
---
...
1. Create a new Eloquent Collection instance.
2. @param  array<int, \Illuminate\Database\Eloquent\Model>  $models
3. @return \Illuminate\Database\Eloquent\Collection<int, \Illuminate\Database\Eloquent\Model>
