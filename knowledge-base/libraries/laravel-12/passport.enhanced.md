...
file_info:
  name: passport.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/passport.md
  size: 58659
structure:
  headings_count: 69
  code_blocks_count: 70
  internal_links_count: 64
processed_at: '2025-11-21T15:35:23.447840Z'
---
...
3. Determine if the client should skip the authorization prompt.
4. @param  \Laravel\Passport\Scope[]  $scopes
5. Find the user instance for the given username.
6. Validate the password of the user for the Passport password grant.

### Related Documentation

- [the upgrade guide](https://github.com/laravel/passport/blob/master/UPGRADE.md)
