...
file_info:
  name: routing.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/routing.md
  size: 40514
structure:
  headings_count: 48
  code_blocks_count: 76
  internal_links_count: 43
processed_at: '2025-11-21T15:35:27.343921Z'
---
...
3. @param  \Closure(\Illuminate\Http\Request): (\Symfony\Component\HttpFoundation\Response)  $next
4. Get the route key for the model.
5. Retrieve the model for a bound value.
6. @param  mixed  $value
7. @param  string|null  $field
8. @return \Illuminate\Database\Eloquent\Model|null
9. Retrieve the child model for a bound value.
10. @param  string  $childType
