...
file_info:
  name: container.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/container.md
  size: 28068
structure:
  headings_count: 29
  code_blocks_count: 45
  internal_links_count: 43
processed_at: '2025-11-21T15:35:12.630717Z'
---
...
2. Show information about the given podcast.
3. Create a new class instance.
4. Create a new attribute instance.
5. Resolve the configuration value.
6. @param  self  $attribute
7. @param  \Illuminate\Contracts\Container\Container  $container
8. The filter instances.
9. Generate a new podcast stats report.
