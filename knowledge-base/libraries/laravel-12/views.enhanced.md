...
file_info:
  name: views.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/views.md
  size: 11160
structure:
  headings_count: 13
  code_blocks_count: 18
  internal_links_count: 18
processed_at: '2025-11-21T15:35:31.082714Z'
---
...
3. Create a new profile composer.
4. Bind data to the view.
