...
- validation
file_info:
  name: precognition.md
  path: /home/user/melly/knowledge-base/libraries/laravel-12/precognition.md
  size: 27278
structure:
  headings_count: 14
  code_blocks_count: 49
  internal_links_count: 22
processed_at: '2025-11-21T15:35:24.323136Z'
---
...
1. Get the validation rules that apply to the request.
